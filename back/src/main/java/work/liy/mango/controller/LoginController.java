...
import work.liy.mango.service.SmsService;
import work.liy.mango.util.GetRandom;
import work.liy.mango.util.login.IsLogin;
...
//        file.transferTo(dest);
        ...
        String url = tencentCOSUtils.upload(file, tencentCOSUtils.getAvatar());
