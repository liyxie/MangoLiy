...
Page({
  ...
  data: {
    ...
    emojiSource: 'https://liy1900-1258789570.cos.ap-guangzhou.myqcloud.com/www/wwwroot/liy/images/0.png',//表情图片
  ...
  /**
   * 'http://www.wmbyte.com/img/chat_message_minip/emoji-sprite.png'
   * 生命周期函数--监听页面加载
   *
   */
